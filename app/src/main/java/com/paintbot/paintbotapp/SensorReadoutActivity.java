...
public class SensorReadoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectedDevice = getIntent().getParcelableExtra(EXTRA_DEVICE);
        distanceList = new ArrayList<>();
        durationList = new ArrayList<>();
        dataReadout = findViewById(R.id.dataReadout);
        ...
        bluetoothDevice = btAdapter.getRemoteDevice(selectedDevice.getAddress());
